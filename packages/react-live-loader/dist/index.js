...
var remoteToComponent = function (url) { return __awaiter(void 0, void 0, void 0, function () {
    var res, text;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                text = _a.sent();
                return [2 /*return*/, exports.rawToCode(text)];
        }
    });
}); };
...
var codeToComponent = function (component) {
    ...
    var func = new Function("require", "module", "exports", component);
    try {
...
var rawToCode = function (text) {
    return compiler_1.compileComponent(text);
};
exports.rawToCode = rawToCode;
var rawToComponent = function (text) {
    var code = exports.rawToCode(text);
    if (code) {
        return exports.codeToComponent(code).default;
    }
};
exports.rawToComponent = rawToComponent;
